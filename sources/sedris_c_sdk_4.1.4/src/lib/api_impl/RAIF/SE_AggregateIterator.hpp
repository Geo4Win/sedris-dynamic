...
#ifndef _SE_AGGREGATE_ITERATOR_HPP_INCLUDED
#define _SE_AGGREGATE_ITERATOR_HPP_INCLUDED


#include "SE_Iterator.hpp"


class SE_AggregateIterator : public SE_Api_Iterator
{

public:

    SE_AggregateIterator(RAIFManager       *my_manager,
			 SE_Api_Object         *start_object,
                         SE_SearchFilter   *search_filter = NULL,
                         SE_ITR_Behaviour itr_flag = SE_ITRBEH_RESOLVE);

    virtual ~SE_AggregateIterator();
