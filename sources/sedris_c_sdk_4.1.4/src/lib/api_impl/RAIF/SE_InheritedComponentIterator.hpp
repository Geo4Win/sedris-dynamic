...
//
// FILE:        SE_InheritedComponentIterator.hpp
//
...
#ifndef _SE_INHERITED_COMPONENT_ITERATOR_HPP_INCLUDED
#define _SE_INHERITED_COMPONENT_ITERATOR_HPP_INCLUDED

#include "SE_Iterator.hpp"

class SE_Api_Object;

class SE_InheritedComponentIterator : public SE_Api_Iterator
{

public:

    SE_InheritedComponentIterator(RAIFManager *my_mngr,
    ...
    virtual ~SE_InheritedComponentIterator();
...
#endif // _SE_INHERITED_COMPONENT_ITERATOR_HPP_INCLUDED
