...
//
// FILE:        SE_AssociationIterator.hpp
//
// PROGRAMMERS: Robert D'Urso (SAIC), Howard Lu (SAIC),
//              Bill Horan (SAIC), Warren Macchi (Arteon)
//
// DESCRIPTION: contains class definition for SE_AssociationIterator,
//              the SE_Api_Iterator subclass that allows traversal
//              through all of an object's associations.
//
// - API spec. 4.1
...
#ifndef _SE_ASSOCIATION_ITERATOR_HPP_INCLUDED
#define _SE_ASSOCIATION_ITERATOR_HPP_INCLUDED

#include "SE_Iterator.hpp"

class SE_Api_Object;

class SE_AssociationIterator : public SE_Api_Iterator
{
public:
    SE_AssociationIterator(RAIFManager       *my_manager,
                           SE_Api_Object         *start_object,
                           SE_SearchFilter   *search_filter = NULL,
                           SE_ITR_Behaviour itr_flag = SE_ITRBEH_RESOLVE);

    virtual ~SE_AssociationIterator();
