 ...
 */
#ifndef _SE_LEVEL_0_WRITE_API_H_INCLUDED
#define _SE_LEVEL_0_WRITE_API_H_INCLUDED
...
#include <se_insert.h> /* A header file containing the interface to */
                       /* insert data into a SEDRIS transmittal    */

#include "se_insert_print.h"
