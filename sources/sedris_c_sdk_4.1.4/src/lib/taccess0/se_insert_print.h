 ...
 *
 * FILE       : se_insert_print.h
 *
 * PROGRAMMERS: Michele L. Worley (SAIC)
 *
 * DESCRIPTION:
 *   Contains print functions for all SEDRIS Level 0 Read API types.
 *
...
/*
 * Ensure that se_insert_print.h is included only once.
 */
#ifndef _SE_LEVEL_0_WRITE_API_PRINT_H_INCLUDED
#define _SE_LEVEL_0_WRITE_API_PRINT_H_INCLUDED
...
#endif /* #ifndef/define/endif for _SE_LEVEL0_WRITE_API_PRINT_H_INCLUDED */
