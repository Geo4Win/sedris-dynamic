 ...
 *    regard to constraints affecting <Model> instances.
 *
...
#ifndef RULE_CHECKER_MODEL_H_DEFINED
#define RULE_CHECKER_MODEL_H_DEFINED
 ...
 *
 *   Check the <Model Library> and its components for compliance with the
