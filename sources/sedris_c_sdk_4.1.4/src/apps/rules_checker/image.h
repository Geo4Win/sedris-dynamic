 ...
 *    regard to constraints affecting <Image> instances.
 *
...
#ifndef RULE_CHECKER_IMAGE_H_DEFINED
#define RULE_CHECKER_IMAGE_H_DEFINED
 ...
 *
 *   Check the Image Library and its components for the following business
 *   rules:
 *   - Mandatory_Metadata
 *
 *-----------------------------------------------------------------------------
