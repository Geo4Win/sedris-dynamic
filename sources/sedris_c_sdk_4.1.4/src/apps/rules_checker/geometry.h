 ...
 *    regard to constraints affecting <Geometry Representation> instances.
 *
...
#ifndef RULE_CHECKER_GEOMETRY_H_DEFINED
#define RULE_CHECKER_GEOMETRY_H_DEFINED
