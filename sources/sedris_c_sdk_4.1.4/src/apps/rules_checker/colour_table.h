 ...
 *    regard to business rules affecting Colour Tables.
 *
...
#ifndef RULE_CHECKER_COLOUR_TABLE_H_DEFINED
#define RULE_CHECKER_COLOUR_TABLE_H_DEFINED
 ...
 *
 *   Check the Colour Index:
 *   - in range for the referenced <Colour Table Group>
 *
 *-----------------------------------------------------------------------------
 */
extern void
 ...
 *
 *   Check the Inline Colour's <Primitive Colour>.
 *
 *-----------------------------------------------------------------------------
 */
extern void
...
(
    SE_Short_Integer_Unsigned  level,
    SE_DRM_Class               path[MAX_CHECKER_PATH_LENGTH],
    SE_Object                  colour_table_library,
    SE_LOCAL_SUMMARY          *summary
);
